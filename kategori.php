...
<html>
	<head>
		<title>Scraptify Lite - Kategori</title>
				...
				<div class="col-md-4 products-left">
					<div class="categories">
						...
						<ul class="cate">
							...
							<li>
								<a href="kategori.php?idkategori=<?php echo $p['idkategori'] ?>">
									<i class="fa fa-arrow-right" aria-hidden="true"></i><?php echo $p['namakategori'] ?>
								</a>
							</li>
										...
										<figure>
											<div class="snipcart-item block">
												<div class="snipcart-thumb">
													...
													<h4>Rp<?php echo number_format($p['hargaafter']) ?> <span>Rp<?php echo number_format($p['hargaafter']+10000) ?></span></h4>
												</div>
