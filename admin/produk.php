<?php 
		...
		if($tipe_file == "image/jpeg" || $tipe_file == "image/png"){
		  if($ukuran_file <= 5000000){ 
			if(move_uploaded_file($tmp_file, $path)){ 
			  ...
			  $query = "insert into produk (idkategori, namaproduk, gambar, deskripsi, hargaafter)
	...
	if(isset($_POST["editproduk"])){
		...
		$deskripsi=$_POST['deskripsi'];
		$hargaafter=$_POST['hargaafter'];
		$q1 = mysqli_query($conn, "update produk set namaproduk='$namaproduk', deskripsi='$deskripsi', hargaafter='$hargaafter' where idproduk='$kode'");
		if($q1){
...
<html class="no-js" lang="en">
	<head>
		...
		<title>Kelola Produk - Scraptify Lite</title>
										...
										<table id="dataTable3" class="display" style="width:100%">
											...
											<tbody>
												...
												<tr>
													...
													<td>
														<button type="button" data-toggle="modal" data-target="#edit<?php echo $p['idproduk'] ?>" class="btn btn-warning">
															Edit
														</button>
														<input type="hidden" name="idproduknya" value="<?php echo $p['idproduk'] ?>" \>
														<button type="button" data-toggle="modal" data-target="#hapus<?php echo $p['idproduk'] ?>" class="btn btn-danger">
															Hapus
														</button>
													</td>
												</tr>
													...
													<!-- Edit -->
													<div class="modal fade" id="edit<?php echo $p['idproduk'] ?>">
															...
															<div class="modal-content">
																...
																<form method="post">
																		...
																		<div class="form-group">
																			...
																			<input name="deskripsi" value=<?php echo $p['deskripsi'] ?> type="text" class="form-control" required>
																		</div>
																		<div class="form-group">
																			<label>Harga</label>
																			<input name="hargaafter" value=<?php echo $p['hargaafter'] ?> type="number" class="form-control">
																		</div>
																		<input type="hidden" name="idproduknya" value="<?php echo $p['idproduk'] ?>" \>
																	</div>
													...
													<!-- hapus -->
													<div class="modal fade" id="hapus<?php echo $p['idproduk'] ?>">
														<div class="modal-dialog">
															<div class="modal-content">
																<div class="modal-header">
																...
																<form method="post">
																		...
																		<div class="form-group">
																			...
																			<select name="idkategori" value=<?php echo $p['namakategori'] ?> class="form-control">
																	...
																	<div class="modal-footer">
																		<button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
																		<input name="hapusproduk" type="submit" class="btn btn-danger" value="Hapus">
																	</div>
																</form>
															</div>
														</div>
