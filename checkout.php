...
<html>
	<head>
		<title>Scraptify Lite - Checkout</title>
		<!-- for-mobile-apps -->
	...
	<body>
		...
		<div class="checkout">
			<div class="container">
				<h1>
					Terima kasih, <?=$_SESSION['name']?> telah membeli <?php echo $itungtrans3 ?> barang di Scraptify Lite</span>
				</h1>
				...
				<center>
					...
					<br>
					<form method="post">
					<input type="submit" class="form-control btn btn-success" name="checkout" value="Order Barang" \>
					</form>
				</center>
			</div>
		</div>
